...
The initial Froude number of the simulation is 0.841
The excursion Froude number of the simulation is 1.03
The total length of the domain is 300 meters
The relative slope steepness is 1.03, slope is supercritical
If wave has a velocity of 0.025 m/s (2.51 cm/s) and the domain is 300 m
 it will take 11963 seconds (3.32 hours) to traverse the domain.
...
The open-boundary inflow velocity, Uinflow, is 2.51 cm/s (0.025 m/s)
...
Simulation time step set at value 'deltaT = 0.1s'
